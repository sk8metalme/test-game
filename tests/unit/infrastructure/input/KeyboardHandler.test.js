...
describe('KeyboardHandler', () => {
  ...
  describe('基本キー入力処理', () => {
    ...
    test('未定義キーは無視される', () => {
      ...
      expect(Object.values(mockCallbacks).every(callback => 
  ...
  describe('統計情報', () => {
    ...
    test('平均入力レートが計算される', () => {
      ...
      // 時間間隔を空けて入力
      keyboardHandler.handleKeyDown(createKeyEvent('keydown', 'ArrowLeft', { timeStamp: baseTime }));
      keyboardHandler.handleKeyDown(createKeyEvent('keydown', 'ArrowRight', { timeStamp: baseTime + 1000 }));
