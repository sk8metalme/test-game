 ...
 * ゲームのパフォーマンス指標とベンチマークをテストします
 */

import { PERFORMANCE_BENCHMARKS, BOARD_SCENARIOS } from '../test-data.js';

describe('Performance Benchmarks', () => {
  let game, board, renderer, performanceSpy;

  beforeEach(() => {
    // パフォーマンス測定の準備
    performanceSpy = TestUtils.createPerformanceSpy();
